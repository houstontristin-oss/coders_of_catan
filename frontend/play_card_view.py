...
from .constants import (
    ...
    CARD_BACK_BTN_W, CARD_BTN_H, TEXT_WHITE, CARD_BACK_TEXT_SIZE, CARD_BUY_LABEL,CARD_BUY_TEXT_SIZE,
    CARD_PLAY_LABEL, CARD_PLAY_BTN_W, CARD_PLAY_TEXT_SIZE, CARD_NOTIF_Y, SCREEN_HEIGHT, CARD_BTN_W,
    CARD_NOTIF_TIMER, CARD_W, CARD_GAP, CARD_TOP, CARD_H, CARD_BOTTOM_BAR_H, CARD_LIFT_SELECTED,
